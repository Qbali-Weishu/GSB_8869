...
class PrivEscChecker:
    ...
    def __init__(self):
        ...
        # 可写系统目录列表（测试版）
        self.system_dirs = [
            '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/writable_etc', '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/etc', '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/usr/bin',
    ...
    def check_cron(self) -> List[Dict[str, Any]]:
        ...
        # 检查系统cron目录（测试版）
        cron_dirs = [
            '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/etc/cron.d/test_backup',
            '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/etc/cron.d',
            '/etc/cron.daily',
            '/etc/cron.hourly',
            '/etc/cron.weekly',
            '/etc/cron.monthly',
    ...
    def check_sudo(self) -> List[Dict[str, Any]]:
        ...
        # 检查sudoers文件权限（测试版）
        sudoers_path = '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/etc/sudoers'
        sudoers_d_path = '/Volumes/Data/PROJECT/GSB/26_4_30/8869/test_env/etc/sudoers.d'
